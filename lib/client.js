...
function NodeView({ node }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
    ...
    node.shape !== "diamond" && node.sub !== "" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: cx, y: cy + 18, fill: MUTED, fontSize: 9, fontFamily: MONO, textAnchor: "middle", children: node.sub })
  ] });
}
var DiagramCard = (0, import_react4.memo)(function DiagramCard2({ spec }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("figure", { className: "dtt-diagram", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("svg", { viewBox: "0 0 800 " + height, role: "img", "aria-labelledby": uid + "-t " + uid + "-d", children: [
    ...
    spec.nodes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(NodeView, { node: n }, n.id)),
