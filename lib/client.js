...
function Chip({ label, value, kind: kind2, title }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dtt__card-chip", "data-kind": kind2, title: title ?? `${label} ${value}`, children: [
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dtt__card-head", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dtt__card-chips", children: [
            ...
            git !== void 0 && git > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Chip, { label: "Git", value: String(git), kind: "git", title: gitDetail !== void 0 && gitDetail !== "" ? `Git \u64CD\u4F5C ${git} \u6B21\uFF08${gitDetail}\uFF09` : `Git \u64CD\u4F5C ${git} \u6B21` })
          ] })
        ] }),
...
function EdgeView({ edge, marker }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { d, fill: "none", stroke: color ?? MUTED, strokeWidth: edge.accent ? 1.4 : 1.2, markerEnd: "url(#" + marker + ")" }),
    edge.label !== "" && horizontal && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("rect", { x: mid[0] - 18, y: mid[1] - 20, width: 36, height: 12, rx: 2, fill: PAPER }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: mid[0], y: mid[1] - 11, fill: SOFT, fontSize: 8, fontFamily: MONO, textAnchor: "middle", children: edge.label })
    ] })
  ] });
}
function NodeView({ node, compact }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
    node.shape === "diamond" ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("polygon", { points: cx + "," + node.y + " " + (node.x + node.w) + "," + cy + " " + cx + "," + (node.y + node.h) + " " + node.x + "," + cy, fill: PAPER }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("polygon", { points: cx + "," + node.y + " " + (node.x + node.w) + "," + cy + " " + cx + "," + (node.y + node.h) + " " + node.x + "," + cy, fill, stroke, strokeWidth: sw })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("rect", { x: node.x, y: node.y, width: node.w, height: node.h, rx: node.shape === "oval" ? Math.min(20, node.h / 2) : 6, fill: PAPER }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("rect", { x: node.x, y: node.y, width: node.w, height: node.h, rx: node.shape === "oval" ? Math.min(20, node.h / 2) : 6, fill, stroke, strokeWidth: sw })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: cx, y: node.shape === "diamond" ? cy + 4 : cy + 2, fill: INK, fontSize: 12, fontWeight: 600, fontFamily: SANS, textAnchor: "middle", children: node.name }),
    !compact && node.shape !== "diamond" && node.sub !== "" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: cx, y: cy + 18, fill: MUTED, fontSize: 9, fontFamily: MONO, textAnchor: "middle", children: node.sub })
  ] });
}
var DiagramCard = (0, import_react4.memo)(function DiagramCard2({ spec }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("figure", { className: "dtt-diagram" + (mode === "compact" ? " dtt-diagram--compact" : mode === "large" ? " dtt-diagram--large" : ""), children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dtt-dg-scale", role: "group", "aria-label": "\u6E32\u67D3\u6BD4\u4F8B", children: [["compact", "\u7D27", "\u7D27\u51D1"], ["full", "\u6807", "\u6807\u51C6"], ["large", "\u5927", "\u653E\u5927"]].map(([value, short, tip]) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("svg", { viewBox: vx + " " + vy + " " + vbW + " " + vbH, style: mode === "large" ? { width: "100%", maxWidth: vbW, margin: "0 auto", minWidth: 1e3 } : { width: "100%", maxWidth: vbW, margin: "0 auto" }, role: "img", "aria-labelledby": uid + "-t " + uid + "-d", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("title", { id: uid + "-t", children: spec.title }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("desc", { id: uid + "-d", children: spec.desc !== "" ? spec.desc : spec.title }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("defs", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("marker", { id: marker, markerWidth: "8", markerHeight: "6", refX: "7", refY: "3", orient: "auto", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("polygon", { points: "0 0, 8 3, 0 6", fill: MUTED }) }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("marker", { id: markerA, markerWidth: "8", markerHeight: "6", refX: "7", refY: "3", orient: "auto", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("polygon", { points: "0 0, 8 3, 0 6", fill: ACCENT }) })
      ] }),
      spec.edges.map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(EdgeView, { edge: e, marker: e.accent ? markerA : marker }, i)),
      spec.nodes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(NodeView, { node: n, compact }, n.id)),
      !compact && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: vx + 24, y1: legendY, x2: vx + vbW - 24, y2: legendY, stroke: STROKE, strokeWidth: 0.8 }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: vx + 24, y: legendY + 20, fill: SOFT, fontSize: 8, fontFamily: MONO, letterSpacing: "0.14em", children: "LEGEND" }),
        items.map((it, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { transform: "translate(" + (vx + 120 + i * 160) + "," + (legendY + 8) + ")", children: [
          it.kind === "diamond" ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("polygon", { points: "20,0 32,10 20,20 8,10", fill: PAPER, stroke: STROKE }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("rect", { x: "0", y: "0", width: "40", height: "20", rx: it.kind === "oval" ? 10 : 6, fill: it.kind === "focal" ? ACCENT_TINT : PAPER, stroke: it.kind === "focal" ? ACCENT : STROKE, strokeWidth: it.kind === "focal" ? 1.6 : 1 }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: "48", y: "14", fill: SOFT, fontSize: 8, fontFamily: MONO, children: it.label })
        ] }, it.kind))
      ] })
    ] })
  ] });
...
function Minis({ tab }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt-proto__minis", children: tab.minis.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt-proto__mini", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("b", { children: m.t }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: m.d })
  ] }, i)) });
}
var ProtoTabsCard = (0, import_react5.memo)(function ProtoTabsCard2({ spec }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt-proto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt-proto__head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt-proto__title", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__dot", "aria-hidden": true }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: spec.title })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt-proto__tabs", role: "tablist", children: spec.tabs.map((t, i) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "button",
        {
          type: "button",
          role: "tab",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt-proto__panel", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt-proto__heading", children: tab.heading }),
      variant === "pill" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__bulb", "aria-hidden": true }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__tag", children: tab.pill.tag }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__desc", children: tab.pill.desc }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__arrow", "aria-hidden": true, children: "\u203A" })
            ]
          }
        ),
        open && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt-proto__detail", children: tab.pill.detail })
      ] }),
      variant === "expand" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt-proto__expand", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__tag", children: tab.pill.tag }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__desc", children: tab.pill.desc }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: open ? "dtt-proto__arrow dtt-proto__arrow--open" : "dtt-proto__arrow", "aria-hidden": true, children: "\u203A" })
            ]
          }
        ),
        open && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt-proto__expand-body", children: tab.pill.detail })
      ] }),
      variant === "glow" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt-proto__glow-inner", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__spark", "aria-hidden": true, children: "\u2726" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__tag dtt-proto__tag--dark", children: tab.pill.tag }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__desc dtt-proto__desc--dark", children: tab.pill.desc }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt-proto__arrow dtt-proto__arrow--dark", "aria-hidden": true, children: "\u203A" })
            ] })
          }
        ),
        open && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt-proto__detail", children: tab.pill.detail })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Minis, { tab })
    ] }, safeActive),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt-proto__hint", children: "Tab / \u5361\u7247\u90FD\u53EF\u4EE5\u76F4\u63A5\u70B9\u51FB\u4F53\u9A8C" })
  ] });
});
...
function GeneratedImageStrip({ images, model }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: `${cls.strip}${multi ? ` ${cls.stripMulti}` : ""}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls.row, children: images.map((url, index) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "button",
      {
        type: "button",
        className: cls.item,
        ...
        children: [
          ...
          multi && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls.badge, children: index + 1 })
        ]
      },
    ...
    open !== void 0 && (0, import_react_dom.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls.stage, onClick: (event) => event.stopPropagation(), children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              "button",
              {
                ...
                "aria-label": L.save,
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("svg", { className: cls.saveIcon, viewBox: "0 0 16 16", width: "14", height: "14", "aria-hidden": "true", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M8 1v8m0 0L4.5 5.5M8 9l3.5-3.5", stroke: "currentColor", strokeWidth: "2", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M2.5 11.5v2h11v-2", stroke: "currentColor", strokeWidth: "2", fill: "none", strokeLinecap: "round" })
                  ] }),
            ...
            broken.has(openIndex) ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls.broken, children: L.broken }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "img",
              {
                src: open,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls.metaLine, children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { children: [
                "#",
                openIndex + 1
              ] }),
              model !== null && model !== void 0 && model !== "" && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls.model, children: model })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls.hintLine, children: L.hint })
          ] })
        }
      ),
      document.body
...
function useGeneratedImages(toolNodes) {
  ...
  const [spill, setSpill] = (0, import_react7.useState)(EMPTY2);
...
function ReasoningChip({ items, running, turn, thinkingStart, t }) {
  ...
  const liveText = (0, import_react8.useMemo)(() => {
    if (!running) return "";
  ...
  const liveRef = (0, import_react8.useRef)(null);
  const livePinnedRef = (0, import_react8.useRef)(true);
  const onLiveScroll = (0, import_react8.useCallback)((event) => {
    const el = event.currentTarget;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dtt__reasoning", "data-running": running || void 0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dtt__visually-hidden", children: t("row.running") }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dtt__reasoning-icon", "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_dsh_client_ui_primitives3.IconThinkOutline14, { size: 14 }) }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: running ? elapsed !== void 0 ? `\u601D\u8003\u4E2D \xB7 ${formatDuration(elapsed)}` : "\u601D\u8003\u4E2D\u2026" : `\u601D\u8003 \xD7${items.length}` })
        ]
      }
    ),
    running && liveText !== "" && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dtt__reasoning-live", ref: liveRef, onScroll: onLiveScroll, "aria-live": "polite", children: liveText })
  ] });
}
  ...
  for (let index = 0; index < coalesced.length; index += 1) {
    ...
    switch (block.kind) {
      case "text": {
        const pushMd = (key, text) => {
          ...
          splitDiagram(text).forEach((sub, subIndex) => {
            if (sub.kind === "diagram") {
              rendered.push(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DiagramCard, { spec: sub.spec }, `${key}-dg${subIndex}`));
            } else if (sub.text !== "") {
              rendered.push(
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_dsh_client_ui_primitives3.MarkdownText, { text: sub.text, streaming, labels, fileMentions: mentions }, `${key}-md${subIndex}`)
              );
            }
          });
        };
        ...
        if (parts.length === 1 && parts[0]?.kind === "md" && parts[0].text.indexOf("diagram") < 0) {
          rendered.push(
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_dsh_client_ui_primitives3.MarkdownText, { text: block.text, streaming, labels, fileMentions: mentions }, index)
          );
        } else {
          parts.forEach((part, partIndex) => {
            if (part.kind === "card") {
              rendered.push(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ProtoTabsCard, { spec: part.spec }, `${index}-${partIndex}`));
            } else {
      ...
      case "image": {
        ...
        rendered.push(
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_react9.Fragment, { children: renderMessageImages({
...
var ThinkingStepNodeView = (0, import_react8.memo)(function ThinkingStepNodeView2(props) {
  ...
  const gallery = generated.urls.length > 0 && node.key === galleryStepKey ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(GeneratedImageStrip, { images: generated.urls, model: generated.model }) : void 0;
  ...
  const chip = isFirstStep && reasoningItems.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    ReasoningChip,
    {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "dtt__assistant", "data-streaming": streaming || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "dtt__assistant-body", children: [
    chip,
    rendered.length > 0 && (variant !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(FlowCard, { variant, meta: cardMeta, interrupted, children: [
      rendered,
      gallery
    ...
    interrupted && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "dtt__stopped", children: t("message.stopped") })
  ] }) });
});
...
function EditableText(props) {
  const [draft, setDraft] = (0, import_react11.useState)(props.value);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.group, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.label, children: props.label }),
...
function ShotPanel({ closing, onClose, collect, title }) {
  const [range, setRange] = (0, import_react11.useState)("reply");
  const [theme, setTheme] = (0, import_react11.useState)(() => currentTheme());
  const [device, setDevice] = (0, import_react11.useState)("desktop");
  const [quality, setQuality] = (0, import_react11.useState)("2k");
  const [aspect, setAspect] = (0, import_react11.useState)("auto");
  const [titleText, setTitleText] = (0, import_react11.useState)(title);
  const [labelText, setLabelText] = (0, import_react11.useState)("Kr");
  ...
  const [savedPath, setSavedPath] = (0, import_react11.useState)(null);
  const [editing, setEditing] = (0, import_react11.useState)(false);
  const [baseHtml, setBaseHtml] = (0, import_react11.useState)(null);
  const [editHtml, setEditHtml] = (0, import_react11.useState)(null);
  const [marked, setMarked] = (0, import_react11.useState)(0);
  const tokenRef = (0, import_react11.useRef)(0);
  const editorRef = (0, import_react11.useRef)(null);
  const messages = (0, import_react11.useMemo)(() => collect(range), [collect, range]);
  ...
  const resetEdit = (0, import_react11.useCallback)(() => {
    if (baseHtml === null) return;
    setEditHtml(baseHtml);
    setMarked(0);
  }, [baseHtml]);
  const stopEdit = (0, import_react11.useCallback)(() => {
    setEditing(false);
    setBaseHtml(null);
    setEditHtml(null);
    setMarked(0);
  ...
  const applyDelete = (0, import_react11.useCallback)(() => {
    const frame = editorRef.current;
    const doc = frame?.contentDocument;
    if (doc == null || doc.body === null) return;
  ...
  const switchRange = (0, import_react11.useCallback)((next) => {
    setRange(next);
  }, []);
  ...
  const onCopyPath = (0, import_react11.useCallback)(() => {
  ...
  return (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: cls2.mask, "aria-hidden": "true", onClick: onClose }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.panel, "data-anim": anim, "data-editing": editing || void 0, role: "dialog", "aria-modal": "true", "aria-label": "\u5BF9\u8BDD\u622A\u56FE", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.head, children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.title, children: "\u5BF9\u8BDD\u622A\u56FE" }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: cls2.close, "aria-label": "\u5173\u95ED", onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("svg", { width: "15", height: "15", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M4 4l8 8M12 4l-8 8", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }) }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.bar, children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.label, children: "\u8303\u56F4" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u622A\u56FE\u8303\u56F4", children: ["reply", "turn", "all"].map((item) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.label, children: "\u7248\u5F0F" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u8BBE\u5907\u7248\u5F0F", children: Object.keys(DEVICE_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.label, children: "\u753B\u8D28" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u8F93\u51FA\u753B\u8D28", children: Object.keys(QUALITY_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.label, children: "\u753B\u5E45" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u753B\u5E45\u6BD4\u4F8B", children: SHOT_ASPECTS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.label, children: "\u4E3B\u9898" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "select",
              {
                ...
                children: Object.keys(THEME_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("option", { value: item, children: THEME_LABEL[item] }, item))
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.bar, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { className: cls2.meta, children: [
            "\u8F93\u51FA\u5BBD\u7EA6 ",
            preset.cssWidth * preset.scale,
            " px"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: cls2.stage, children: editing && editHtml !== null ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.editBar, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.editHint, children: "\u70B9\u51FB\u9875\u9762\u4E0A\u7684\u5143\u7D20\u8FDB\u884C\u5220\u9664\uFF1B\u70B9\u51FB\u5DF2\u6807\u8BB0\u7684\u5143\u7D20\u53D6\u6D88\u6807\u8BB0" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { className: cls2.editCount, "data-n": marked > 0 ? "" : void 0, children: [
              "\u5DF2\u6807\u8BB0 ",
              marked,
              " \u4E2A"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.editSpacer }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: cls2.editor, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            "iframe",
            {
              ref: editorRef,
        ...
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.canvas, children: [
          busy && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.hint, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cls2.spinner }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { children: "\u6B63\u5728\u6E32\u67D3\u2026" })
          ] }),
          !busy && error !== null && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: cls2.error, children: error }),
          !busy && error === null && result !== null && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("img", { className: cls2.img, src: result.imageUrl, alt: "\u622A\u56FE\u9884\u89C8" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.foot, children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: toast !== null ? `${cls2.meta} ${cls2.toast}` : cls2.meta, children: toast !== null ? toast : meta }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: cls2.actions, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: cls2.action, disabled: busy, onClick: () => {
              if (editing) stopEdit();
              run();
            }, children: "\u91CD\u65B0\u6E32\u67D3" }),
            result !== null && typeof result.html === "string" && !editing && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: cls2.action, disabled: busy, onClick: startEdit, children: "\u5143\u7D20\u5220\u9664" }),
            savedPath !== null && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: cls2.action, onClick: onCopyPath, children: "\u590D\u5236\u8DEF\u5F84" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: cls2.action, disabled: result === null, onClick: onCopy, children: "\u590D\u5236\u56FE\u7247" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "a",
              {
                className: cls2.action,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: cls2.action, onClick: () => {
              void reveal();
            }, children: "\u6253\u5F00\u76EE\u5F55" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: cls2.primary, disabled: result === null, onClick: onSave, children: "\u4FDD\u5B58" })
          ] })
        ] })
      ] })
    ] }),
...
function CameraIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
    "path",
    {
      fill: "currentColor",
      fillRule: "evenodd",
...
function AssistantScreenshotAction(props) {
  ...
  const snapRef = (0, import_react12.useRef)(null);
  useChat((snapshot) => {
    snapRef.current = snapshot;
    return 0;
  });
  const collect = (0, import_react12.useCallback)((range) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "button",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(CameraIcon, {})
      }
    ),
    open && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ShotPanel, { closing, onClose: requestClose, collect, title })
  ] });
}
