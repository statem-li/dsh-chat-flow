...
function GeneratedImageStrip({ images, model }) {
  const [openIndex, setOpenIndex] = (0, import_react4.useState)(null);
  const [broken, setBroken] = (0, import_react4.useState)(/* @__PURE__ */ new Set());
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${cls.strip}${multi ? ` ${cls.stripMulti}` : ""}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: cls.row, children: images.map((url, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "button",
      {
        type: "button",
        className: cls.item,
        ...
        children: [
          ...
          multi && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: cls.badge, children: index + 1 })
        ]
      },
    ...
    open !== void 0 && (0, import_react_dom.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: cls.stage, onClick: (event) => event.stopPropagation(), children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
              "button",
              {
                ...
                "aria-label": L.save,
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("svg", { className: cls.saveIcon, viewBox: "0 0 16 16", width: "14", height: "14", "aria-hidden": "true", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { d: "M8 1v8m0 0L4.5 5.5M8 9l3.5-3.5", stroke: "currentColor", strokeWidth: "2", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }),
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { d: "M2.5 11.5v2h11v-2", stroke: "currentColor", strokeWidth: "2", fill: "none", strokeLinecap: "round" })
                  ] }),
            ...
            broken.has(openIndex) ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: cls.broken, children: L.broken }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "img",
              {
                src: open,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: cls.metaLine, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { children: [
                "#",
                openIndex + 1
              ] }),
              model !== null && model !== void 0 && model !== "" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: cls.model, children: model })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: cls.hintLine, children: L.hint })
          ] })
        }
      ),
      document.body
...
function useGeneratedImages(toolNodes) {
  ...
  const [spill, setSpill] = (0, import_react5.useState)(EMPTY2);
...
function ReasoningChip({ items, running, turn, thinkingStart, t }) {
  ...
  const liveText = (0, import_react6.useMemo)(() => {
    if (!running) return "";
  ...
  const liveRef = (0, import_react6.useRef)(null);
  const livePinnedRef = (0, import_react6.useRef)(true);
  const onLiveScroll = (0, import_react6.useCallback)((event) => {
    const el = event.currentTarget;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt__reasoning", "data-running": running || void 0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt__visually-hidden", children: t("row.running") }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt__reasoning-icon", "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives3.IconThinkOutline14, { size: 14 }) }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: running ? elapsed !== void 0 ? `\u601D\u8003\u4E2D \xB7 ${formatDuration(elapsed)}` : "\u601D\u8003\u4E2D\u2026" : `\u601D\u8003 \xD7${items.length}` })
        ]
      }
    ),
    running && liveText !== "" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt__reasoning-live", ref: liveRef, onScroll: onLiveScroll, "aria-live": "polite", children: liveText })
  ] });
}
function AssistantBody({ blocks, streaming, interrupted, renderMessageImages, mentions, labels, t }) {
  ...
  for (let index = 0; index < blocks.length; index += 1) {
    ...
    switch (block.kind) {
      case "text":
        rendered.push(
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives3.MarkdownText, { text: block.text, streaming, labels, fileMentions: mentions }, index)
        );
        break;
      case "reasoning":
        break;
      case "image": {
        ...
        rendered.push(
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_react7.Fragment, { children: renderMessageImages({
...
var ThinkingStepNodeView = (0, import_react6.memo)(function ThinkingStepNodeView2(props) {
  ...
  const owner = (0, import_react6.useMemo)(() => {
  ...
  const mentions = (0, import_react6.useMemo)(
  ...
  const reasoningItems = (0, import_react6.useMemo)(() => steps.flatMap((step) => {
  ...
  const gallery = generated.urls.length > 0 && node.key === galleryStepKey ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(GeneratedImageStrip, { images: generated.urls, model: generated.model }) : void 0;
  const thinkingStart = (0, import_react6.useMemo)(() => {
    const runningStep = steps.find((step) => step.data.status === "running");
    return runningStep?.data.time;
  }, [steps]);
  const visibleBlocks = (0, import_react6.useMemo)(
    () => data.blocks.filter((block) => block.kind !== "reasoning"),
    [data.blocks]
  );
  const chip = isFirstStep && reasoningItems.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
    ReasoningChip,
    {
  ...
  const cardMeta = (0, import_react6.useMemo)(() => {
  ...
  const labels = (0, import_react6.useMemo)(() => markdownLabelsFrom(t), [t]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt__assistant", "data-streaming": streaming || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt__assistant-body", children: [
    chip,
    rendered.length > 0 && (variant !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(FlowCard, { variant, meta: cardMeta, interrupted, children: [
      rendered,
      gallery
    ...
    interrupted && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt__stopped", children: t("message.stopped") })
  ] }) });
});
...
function useModalClose(open, onClose, durationMs = MODAL_ANIM_MS) {
  ...
  const closingRef = (0, import_react8.useRef)(false);
  ...
  const requestClose = (0, import_react8.useCallback)(() => {
...
function EditableText(props) {
  const [draft, setDraft] = (0, import_react9.useState)(props.value);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.group, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.label, children: props.label }),
...
function ShotPanel({ closing, onClose, collect, title }) {
  const [range, setRange] = (0, import_react9.useState)("reply");
  const [theme, setTheme] = (0, import_react9.useState)(() => currentTheme());
  const [device, setDevice] = (0, import_react9.useState)("desktop");
  const [quality, setQuality] = (0, import_react9.useState)("2k");
  const [aspect, setAspect] = (0, import_react9.useState)("auto");
  const [titleText, setTitleText] = (0, import_react9.useState)(title);
  const [labelText, setLabelText] = (0, import_react9.useState)("Kr");
  ...
  const [savedPath, setSavedPath] = (0, import_react9.useState)(null);
  const [editing, setEditing] = (0, import_react9.useState)(false);
  const [baseHtml, setBaseHtml] = (0, import_react9.useState)(null);
  const [editHtml, setEditHtml] = (0, import_react9.useState)(null);
  const [marked, setMarked] = (0, import_react9.useState)(0);
  const tokenRef = (0, import_react9.useRef)(0);
  const editorRef = (0, import_react9.useRef)(null);
  const messages = (0, import_react9.useMemo)(() => collect(range), [collect, range]);
  ...
  const startEdit = (0, import_react9.useCallback)(() => {
  ...
  const resetEdit = (0, import_react9.useCallback)(() => {
    if (baseHtml === null) return;
    setEditHtml(baseHtml);
    setMarked(0);
  }, [baseHtml]);
  const stopEdit = (0, import_react9.useCallback)(() => {
    setEditing(false);
    setBaseHtml(null);
    setEditHtml(null);
    setMarked(0);
  ...
  const applyDelete = (0, import_react9.useCallback)(() => {
    const frame = editorRef.current;
    const doc = frame?.contentDocument;
    if (doc == null || doc.body === null) return;
  ...
  const switchRange = (0, import_react9.useCallback)((next) => {
    setRange(next);
  }, []);
  const onSave = (0, import_react9.useCallback)(() => {
  ...
  const onCopy = (0, import_react9.useCallback)(() => {
    if (result === null) return;
    const write = async () => {
  ...
  const onCopyPath = (0, import_react9.useCallback)(() => {
  ...
  return (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls2.mask, "aria-hidden": "true", onClick: onClose }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.panel, "data-anim": anim, "data-editing": editing || void 0, role: "dialog", "aria-modal": "true", "aria-label": "\u5BF9\u8BDD\u622A\u56FE", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.head, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.title, children: "\u5BF9\u8BDD\u622A\u56FE" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: cls2.close, "aria-label": "\u5173\u95ED", onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("svg", { width: "15", height: "15", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M4 4l8 8M12 4l-8 8", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }) }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.bar, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.label, children: "\u8303\u56F4" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u622A\u56FE\u8303\u56F4", children: ["reply", "turn", "all"].map((item) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.label, children: "\u7248\u5F0F" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u8BBE\u5907\u7248\u5F0F", children: Object.keys(DEVICE_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.label, children: "\u753B\u8D28" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u8F93\u51FA\u753B\u8D28", children: Object.keys(QUALITY_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.label, children: "\u753B\u5E45" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u753B\u5E45\u6BD4\u4F8B", children: SHOT_ASPECTS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.label, children: "\u4E3B\u9898" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "select",
              {
                ...
                children: Object.keys(THEME_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: item, children: THEME_LABEL[item] }, item))
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.bar, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: cls2.meta, children: [
            "\u8F93\u51FA\u5BBD\u7EA6 ",
            preset.cssWidth * preset.scale,
            " px"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls2.stage, children: editing && editHtml !== null ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.editBar, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.editHint, children: "\u70B9\u51FB\u9875\u9762\u4E0A\u7684\u5143\u7D20\u8FDB\u884C\u5220\u9664\uFF1B\u70B9\u51FB\u5DF2\u6807\u8BB0\u7684\u5143\u7D20\u53D6\u6D88\u6807\u8BB0" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: cls2.editCount, "data-n": marked > 0 ? "" : void 0, children: [
              "\u5DF2\u6807\u8BB0 ",
              marked,
              " \u4E2A"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.editSpacer }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls2.editor, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            "iframe",
            {
              ref: editorRef,
        ...
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.canvas, children: [
          busy && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.hint, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: cls2.spinner }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: "\u6B63\u5728\u6E32\u67D3\u2026" })
          ] }),
          !busy && error !== null && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: cls2.error, children: error }),
          !busy && error === null && result !== null && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("img", { className: cls2.img, src: result.imageUrl, alt: "\u622A\u56FE\u9884\u89C8" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.foot, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: toast !== null ? `${cls2.meta} ${cls2.toast}` : cls2.meta, children: toast !== null ? toast : meta }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cls2.actions, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: cls2.action, disabled: busy, onClick: () => {
              if (editing) stopEdit();
              run();
            }, children: "\u91CD\u65B0\u6E32\u67D3" }),
            result !== null && typeof result.html === "string" && !editing && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: cls2.action, disabled: busy, onClick: startEdit, children: "\u5143\u7D20\u5220\u9664" }),
            savedPath !== null && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: cls2.action, onClick: onCopyPath, children: "\u590D\u5236\u8DEF\u5F84" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: cls2.action, disabled: result === null, onClick: onCopy, children: "\u590D\u5236\u56FE\u7247" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "a",
              {
                className: cls2.action,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: cls2.action, onClick: () => {
              void reveal();
            }, children: "\u6253\u5F00\u76EE\u5F55" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: cls2.primary, disabled: result === null, onClick: onSave, children: "\u4FDD\u5B58" })
          ] })
        ] })
      ] })
    ] }),
...
function CameraIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
    "path",
    {
      fill: "currentColor",
      fillRule: "evenodd",
...
function AssistantScreenshotAction(props) {
  ...
  const snapRef = (0, import_react10.useRef)(null);
  useChat((snapshot) => {
    snapRef.current = snapshot;
    return 0;
  });
  const collect = (0, import_react10.useCallback)((range) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ShotPanel, { closing, onClose: requestClose, collect, title })
  ] });
}
