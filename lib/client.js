...
function parseDownload(block) {
  ...
  if (output === "") {
    const psOut = /-OutFile[=\s]+(?:"([^"]+)"|'([^']+)'|(\S+))/i.exec(raw) ?? /-d[=\s]+(?:"([^"]+)"|'([^']+)'|(\S+))\s+(?:--out|-o)[=\s]+(?:"([^"]+)"|'([^']+)'|(\S+))/i.exec(raw);
    if (psOut !== null) {
...
var SimpleToolRow = (0, import_react4.memo)(function SimpleToolRow2({
  ...
  const dlState = useDownloadState(running && activity === "download" ? block.callId : void 0, running);
...
var ToolEntry = (0, import_react4.memo)(function ToolEntry2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: `${NS2}__entry-wrap`, children: [
    ...
    liveDownloadCalls.map(({ block, url, outputPath }) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LiveDownloadCard, { callId: block.callId, url, startedAt: block.time, outputPath }, block.callId)),
