...
// src/client/html-preview/styles.ts
var CSS6 = `/* \u591A\u4E2A\u9884\u89C8\u7EB5\u5411\u5806\u53E0\uFF08\u4E00\u6761\u6B63\u6587\u91CC\u63D0\u5230\u597D\u51E0\u4E2A html\uFF09\u3002 */
...
// src/client/html-preview/parse.ts
var BS = "\\";
var SQ = String.fromCharCode(39);
var DQ = String.fromCharCode(34);
var BT = String.fromCharCode(96);
var CH = "[^" + BS + "s" + SQ + DQ + "<>|" + BT + "()" + BS + "[" + BS + "]*?]";
var EXT_SRC = BS + ".(?:html|htm)";
var TAIL = "(?![" + BS + "w.])";
var HEAD = "(?<![" + BS + "w.])";
var EXT = /\.(?:html|htm)$/i;
var URLISH = /\b[a-z][\w+.-]*:\/\/\S+/gi;
var FILE_URL = /file:\/\/\S+/gi;
var FENCE3 = /(?:^|\n)(```|~~~)[\S\S]*?\1(?:\n|$)/g;
var INLINE = /`([^`\n]+)`/g;
var LINK = /\[[^\]]*\](\s*<?([^)\s>]+)>?\s*)/g;
var STRONG = [
...
var WEAK = /(?:^|\s)([\w\u4e00-\u9fff\d._@+-]{1,80}?\.(?:html|htm))(?![\w.])/gi;
var BAD = /[*?\u0000-\u001f]/;
var PREFIX = /^(?:[A-Za-z]:[\\/]|\\\\|~[\\/]|\.{1,2}[\\/]|\/)/;
function tidy(input) {
  let p = input.trim();
  p = p.replace(/^[<("'\[]+/, "");
  p = p.replace(/[">)\]，,.;:!?、。；：！？]+$/, "");
...
function findLocalHtmlPaths(text) {
  if (!/\.html?/i.test(text)) return [];
  const hits = [];
  const keys = [];
  const add = (rawPath, forced) => {
...
// src/client/html-preview/HtmlPreviewCard.tsx
var import_react9 = require("react");

// src/client/html-preview/api.ts
var ROUTE = "/api/chat-flow/html";
function viewUrl(path, cwd, channel, version) {
...
async function fetchMeta(path, cwd) {
  const params = new URLSearchParams({ path });
  if (cwd !== void 0 && cwd !== "") params.set("cwd", cwd);
  try {
    ...
    if (!type.includes("json")) {
      return response.status === 404 ? { ok: false, code: "no-route", error: "\u9884\u89C8\u670D\u52A1\u672A\u6CE8\u518C\uFF1A\u91CD\u542F DSH \u670D\u52A1\u540E\u751F\u6548" } : { ok: false, code: "internal", error: "HTTP " + response.status };
    }
...
async function openInBrowser(path, cwd) {
...
function Icon({ d, size = 14 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
    "svg",
    {
      ...
      strokeLinejoin: "round",
      "aria-hidden": true,
      children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d })
    }
  );
}
var DOC_PATH = "M4 1.8h5l3 3v9a.7.7 0 0 1-.7.7H4a.7.7 0 0 1-.7-.7v-12A.7.7 0 0 1 4 1.8Z M9 1.9v3.1h3.1";
var EXT_PATH = "M6.4 3.2H3.2v9.6h9.6V9.6 M9.2 2.4h4.4v4.4 M13.6 2.4 7.6 8.4";
var REFRESH_PATH = "M13.4 8a5.4 5.4 0 1 1-1.6-3.8 M13.2 1.9v3h-3";
var CHEVRON_PATH = "M4 6.2 8 10.2l4-4";
var WARN_PATH = "M8 2.6 14.2 13H1.8L8 2.6Z M8 6.6v3 M8 11.4h.01";
function HtmlPreviewCard({ hit, cwd }) {
  const { path, explicit } = hit;
  const [phase, setPhase] = (0, import_react9.useState)("probing");
  const [meta, setMeta] = (0, import_react9.useState)(null);
  const [error, setError] = (0, import_react9.useState)("");
  const [reported, setReported] = (0, import_react9.useState)(0);
  const [loaded, setLoaded] = (0, import_react9.useState)(false);
  const [collapsed, setCollapsed] = (0, import_react9.useState)(false);
  const [fit, setFit] = (0, import_react9.useState)(false);
  const [wrapW, setWrapW] = (0, import_react9.useState)(0);
  const [openHint, setOpenHint] = (0, import_react9.useState)("");
  const [spin, setSpin] = (0, import_react9.useState)(false);
  const [frameKey, setFrameKey] = (0, import_react9.useState)(0);
  const wrapRef = (0, import_react9.useRef)(null);
  const channelRef = (0, import_react9.useRef)("");
  ...
  (0, import_react9.useEffect)(() => {
    ...
    void (async () => {
      ...
      if (!alive) return;
      if (result.ok === true && result.abs !== void 0) {
        setMeta({
          abs: result.abs,
  ...
  const src = (0, import_react9.useMemo)(
  ...
  const boxHeight = collapsed ? 0 : phase === "probing" ? PROBE_H : phase === "error" ? ERROR_H : shownH;
  const reload = (0, import_react9.useCallback)(() => {
    setSpin(true);
    window.setTimeout(() => {
      setSpin(false);
    }, 700);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dhp__card", "data-phase": phase, "data-collapsed": collapsed ? "1" : "0", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dhp__bar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dhp__glyph", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Icon, { d: DOC_PATH, size: 13 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dhp__name", title: meta?.abs ?? path, children: name }),
      meta !== null && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { className: "dhp__meta", children: [
        formatBytes2(meta.size),
        " \xB7 ",
        formatWhen(meta.mtimeMs)
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dhp__gap" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        "button",
        {
          type: "button",
          className: "dhp__btn dhp__btn--main",
          onClick: open,
          title: "\u7528\u7CFB\u7EDF\u9ED8\u8BA4\u6D4F\u89C8\u5668\u6253\u5F00\u8FD9\u4E2A\u6587\u4EF6",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Icon, { d: EXT_PATH, size: 13 }),
            "\u6D4F\u89C8\u5668\u6253\u5F00"
          ]
        }
      ),
      phase === "ready" && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "button",
        {
          type: "button",
          className: "dhp__btn dhp__btn--fit",
          onClick: () => {
            setFit((v) => !v);
          },
          title: fit ? "\u5F53\u524D\u7B49\u6BD4\u7F29\u653E\u5230 " + pct + "%\uFF0C\u70B9\u51FB\u5207 1:1 \u539F\u59CB\u5C3A\u5BF8" : "\u5F53\u524D 1:1 \u539F\u59CB\u5C3A\u5BF8\uFF0C\u70B9\u51FB\u5207\u56DE\u7B49\u6BD4\u7F29\u653E",
          children: fit ? pct + "%" : "1:1"
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        ...
        {
          type: "button",
          className: "dhp__btn dhp__btn--icon",
          "data-spin": spin ? "1" : void 0,
          onClick: reload,
          title: "\u91CD\u65B0\u8BFB\u53D6",
          "aria-label": "\u91CD\u65B0\u8BFB\u53D6",
          children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dhp__spin", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Icon, { d: REFRESH_PATH, size: 13 }) })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "button",
        {
          ...
          title: collapsed ? "\u5C55\u5F00\u9884\u89C8" : "\u6298\u53E0\u9884\u89C8",
          "aria-label": collapsed ? "\u5C55\u5F00\u9884\u89C8" : "\u6298\u53E0\u9884\u89C8",
          children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dhp__chevron", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Icon, { d: CHEVRON_PATH, size: 13 }) })
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dhp__body", ref: wrapRef, style: { height: boxHeight }, children: [
      phase === "ready" && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "iframe",
        {
      ...
      phase === "probing" && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "dhp__loading", "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dhp__rail" }) }),
      phase === "error" && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dhp__empty", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dhp__empty-icon", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Icon, { d: WARN_PATH, size: 15 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "dhp__empty-text", children: error }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: "dhp__btn dhp__btn--ghost", onClick: reload, children: "\u91CD\u8BD5" })
      ] })
    ] }),
    openHint !== "" && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "dhp__note", children: openHint })
  ] });
}
function HtmlPreviewStrip({ hits, cwd }) {
  if (hits.length === 0) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "dhp__stack", children: hits.map((item) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(HtmlPreviewCard, { hit: item, cwd }, item.path)) });
}
...
function useGeneratedImages(toolNodes) {
  const scan = (0, import_react10.useMemo)(() => {
    const inline = [];
    const locators = [];
  ...
  const [spill, setSpill] = (0, import_react10.useState)(EMPTY2);
...
function ReasoningChip({ items, running, turn, thinkingStart, t }) {
  ...
  const liveText = (0, import_react11.useMemo)(() => {
    if (!running) return "";
  ...
  const liveRef = (0, import_react11.useRef)(null);
  const livePinnedRef = (0, import_react11.useRef)(true);
  const onLiveScroll = (0, import_react11.useCallback)((event) => {
    const el = event.currentTarget;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dtt__reasoning", "data-running": running || void 0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dtt__visually-hidden", children: t("row.running") }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dtt__reasoning-icon", "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives4.IconThinkOutline14, { size: 14 }) }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { children: running ? elapsed !== void 0 ? `\u601D\u8003\u4E2D \xB7 ${formatDuration(elapsed)}` : "\u601D\u8003\u4E2D\u2026" : `\u601D\u8003 \xD7${items.length}` })
        ]
      }
    ),
    running && liveText !== "" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dtt__reasoning-live", ref: liveRef, onScroll: onLiveScroll, "aria-live": "polite", children: liveText })
  ] });
}
  ...
  for (let index = 0; index < coalesced.length; index += 1) {
    ...
    switch (block.kind) {
      case "text": {
        const pushMd = (key, text) => {
          ...
          splitDiagram(text).forEach((sub, subIndex) => {
            if (sub.kind === "diagram") {
              rendered.push(/* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DiagramCard, { spec: sub.spec }, `${key}-dg${subIndex}`));
            } else if (sub.text !== "") {
              rendered.push(
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives4.MarkdownText, { text: sub.text, streaming, labels, fileMentions: mentions }, `${key}-md${subIndex}`)
              );
            }
          });
        };
        ...
        if (parts.length === 1 && parts[0]?.kind === "md" && parts[0].text.indexOf("diagram") < 0) {
          rendered.push(
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives4.MarkdownText, { text: block.text, streaming, labels, fileMentions: mentions }, index)
          );
        } else {
          parts.forEach((part, partIndex) => {
            if (part.kind === "card") {
              rendered.push(/* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ProtoTabsCard, { spec: part.spec }, `${index}-${partIndex}`));
            } else {
        ...
        if (!streaming) {
          ...
          if (hits.length > 0) rendered.push(/* @__PURE__ */ (0, import_jsx_runtime10.jsx)(HtmlPreviewStrip, { hits, cwd }, "hp" + index));
        }
        break;
      }
      case "reasoning":
      ...
      case "image": {
        ...
        rendered.push(
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_react12.Fragment, { children: renderMessageImages({
...
var ThinkingStepNodeView = (0, import_react11.memo)(function ThinkingStepNodeView2(props) {
  ...
  const owner = (0, import_react11.useMemo)(() => {
  ...
  const mentions = (0, import_react11.useMemo)(
  ...
  const reasoningItems = (0, import_react11.useMemo)(() => steps.flatMap((step) => {
  ...
  const gallery = generated.urls.length > 0 && node.key === galleryStepKey ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(GeneratedImageStrip, { images: generated.urls, model: generated.model }) : void 0;
  const thinkingStart = (0, import_react11.useMemo)(() => {
    const runningStep = steps.find((step) => step.data.status === "running");
    return runningStep?.data.time;
  }, [steps]);
  const visibleBlocks = (0, import_react11.useMemo)(
    () => data.blocks.filter((block) => block.kind !== "reasoning"),
    [data.blocks]
  );
  const chip = isFirstStep && reasoningItems.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
    ReasoningChip,
    {
  ...
  const gitVerbs = (0, import_react11.useMemo)(() => {
    const verbs = [];
  ...
  const gitDetail = (0, import_react11.useMemo)(() => [...new Set(gitVerbs)].join(" \xB7 "), [gitVerbs]);
  ...
  const cardMeta = (0, import_react11.useMemo)(() => {
  ...
  const labels = (0, import_react11.useMemo)(() => markdownLabelsFrom(t), [t]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dtt__assistant", "data-streaming": streaming || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dtt__assistant-body", children: [
    chip,
    rendered.length > 0 && (variant !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(FlowCard, { variant, meta: cardMeta, interrupted, children: [
      rendered,
      gallery
    ...
    interrupted && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dtt__stopped", children: t("message.stopped") })
  ] }) });
});
...
var ROUTE2 = "/api/chat-flow/screenshot";
async function post(path, body) {
  const res = await fetch(`${ROUTE2}${path}`, {
    method: "POST",
    headers: { "content-type": "application/json" },
...
function EditableText(props) {
  const [draft, setDraft] = (0, import_react14.useState)(props.value);
...
function ShotPanel({ closing, onClose, collect, title }) {
  const [range, setRange] = (0, import_react14.useState)("reply");
  const [theme, setTheme] = (0, import_react14.useState)(() => currentTheme());
  const [device, setDevice] = (0, import_react14.useState)("desktop");
  const [quality, setQuality] = (0, import_react14.useState)("2k");
  const [aspect, setAspect] = (0, import_react14.useState)("auto");
  const [titleText, setTitleText] = (0, import_react14.useState)(title);
  const [labelText, setLabelText] = (0, import_react14.useState)("Kr");
  ...
  const [savedPath, setSavedPath] = (0, import_react14.useState)(null);
  const [editing, setEditing] = (0, import_react14.useState)(false);
  const [baseHtml, setBaseHtml] = (0, import_react14.useState)(null);
  const [editHtml, setEditHtml] = (0, import_react14.useState)(null);
  const [marked, setMarked] = (0, import_react14.useState)(0);
  const tokenRef = (0, import_react14.useRef)(0);
  const editorRef = (0, import_react14.useRef)(null);
  const messages = (0, import_react14.useMemo)(() => collect(range), [collect, range]);
  const run = (0, import_react14.useCallback)(() => {
  ...
  const startEdit = (0, import_react14.useCallback)(() => {
  ...
  const resetEdit = (0, import_react14.useCallback)(() => {
    if (baseHtml === null) return;
    setEditHtml(baseHtml);
    setMarked(0);
  }, [baseHtml]);
  const stopEdit = (0, import_react14.useCallback)(() => {
    setEditing(false);
    setBaseHtml(null);
    setEditHtml(null);
    setMarked(0);
  ...
  const applyDelete = (0, import_react14.useCallback)(() => {
    const frame = editorRef.current;
    const doc = frame?.contentDocument;
    if (doc == null || doc.body === null) return;
  ...
  const switchRange = (0, import_react14.useCallback)((next) => {
    setRange(next);
  }, []);
  ...
  const onCopyPath = (0, import_react14.useCallback)(() => {
  ...
  return (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: cls2.panel, "data-anim": anim, "data-editing": editing || void 0, role: "dialog", "aria-modal": "true", "aria-label": "\u5BF9\u8BDD\u622A\u56FE", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: cls2.stage, children: editing && editHtml !== null ? /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: cls2.editBar, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: cls2.editor, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            "iframe",
            {
              ref: editorRef,
        ...
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: cls2.canvas, children: [
          ...
          !busy && error === null && result !== null && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("img", { className: cls2.img, src: result.imageUrl, alt: "\u622A\u56FE\u9884\u89C8" })
        ] }) }),
...
function CameraIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    "path",
    {
      fill: "currentColor",
      fillRule: "evenodd",
...
function AssistantScreenshotAction(props) {
  ...
  const snapRef = (0, import_react15.useRef)(null);
  useChat((snapshot) => {
    snapRef.current = snapshot;
    return 0;
  });
  const collect = (0, import_react15.useCallback)((range) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ShotPanel, { closing, onClose: requestClose, collect, title })
  ] });
}
