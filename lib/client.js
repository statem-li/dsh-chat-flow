...
function HtmlPreviewCard({ hit, cwd }) {
  ...
  const boxHeight = collapsed || phase === "error" ? 0 : phase === "probing" ? MIN_H : Math.max(MIN_H, Math.min(MAX_H, reported > 0 ? reported : FALLBACK_H));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dhp__card", "data-phase": phase, "data-collapsed": collapsed ? "1" : "0", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "dhp__body", style: { height: boxHeight }, children: [
