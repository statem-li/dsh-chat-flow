...
var DiagramCard = (0, import_react4.memo)(function DiagramCard2({ spec }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("figure", { className: "dtt-diagram" + (mode === "compact" ? " dtt-diagram--compact" : mode === "large" ? " dtt-diagram--large" : ""), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("svg", { viewBox: "0 0 800 " + height, style: mode === "large" ? { minWidth: 1e3 } : void 0, role: "img", "aria-labelledby": uid + "-t " + uid + "-d", children: [
      ...
      !compact && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: "30", y1: legendY, x2: "770", y2: legendY, stroke: STROKE, strokeWidth: 0.8 }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: "30", y: legendY + 20, fill: SOFT, fontSize: 8, fontFamily: MONO, letterSpacing: "0.14em", children: "LEGEND" }),
        items.map((it, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { transform: "translate(" + (120 + i * 160) + "," + (legendY + 8) + ")", children: [
